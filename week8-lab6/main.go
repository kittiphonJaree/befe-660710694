...
func getAllBooks(c *gin.Context) {
	...
	var err error
	var newBook Book
	// Level 1 JSON Binding Validation
	...
	if newBook.Year != 0 && (newBook.Year < 1900 || newBook.Year > 2100) {
		c.JSON(http.StatusBadRequest, gin.H{
			"error": "year must be between 1900-2100",
		})
		return
	}
	...
	// Level 5 Database Constraints (handled by DB)
	// - UNIQUE constraints
